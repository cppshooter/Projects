function ExportJQGridDataToExcel(tableCtrl, excelFilename,url) {
    ...
    dataObj.fileName = excelFilename;
    dataObj.excelData = excelData;
    $.ajax({
        type: "POST",
        url: url,
        ...
        success: function (data) {
            //paddyIrrigationCount++;
            //$('#PaddyIrrigation').append(data);
        },
